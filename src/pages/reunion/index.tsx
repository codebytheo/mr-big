    ...
    <Section>
      ...
      <div className='w-full relative flex flex-col md:flex-row justify-between' ref={container}>
        <motion.div
          ...
          className='relative md:top-60 flex flex-1 flex-col space-y-4'>
        ...
        <div className='flex-1 w-full [&>:nth-child(2)]:w-3/4 md:[&>:nth-child(2)]:mt-2 [&>:nth-child(3)]:italic md:[&>:nth-child(3)]:mt-2 [&>:nth-child(4)]:italic md:[&>:nth-child(4)]:mt-2 [&>:nth-child(6)]:italic [&>:nth-child(6)]:w-3/4'>
          {
