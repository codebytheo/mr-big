  ...
  return (
    <Section>
      <div className="relative mb-20">
        <TextTitle text="DEATH OF PAT TORPEY" cn="text-6xl md:text-[120px]" />
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0 mt-10 saturate-0">
