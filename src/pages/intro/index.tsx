  ...
  return (
    <section className="w-11/12 min-h-screen m-auto">
      <div className="flex flex-col items-center leading-none">
        ...
        <div className="relative w-full h-[400px] after:content-[''] after:absolute after:inset-0 after:bg-gradient-to-t after:from-[#111] after:from-4%">
          <ImageProfile src="mr-big-bg2.jpg" cn="w-full h-full" pos="top" />
        </div>

        <MarqueText text="MR.BIG" />

        <div className="w-11/12 font-clashGrotesk text-zinc-300 leading-tight text-[2.5rem] text-justify mt-10">
